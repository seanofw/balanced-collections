...
{
	/// <summary>
	/// This efficiently enumerates the given red-black tree as KeyValuePairs, non-recursively.
	...
	/// </summary>
	internal class RedBlackTreePairEnumerator<K, V, N> : IEnumerator<KeyValuePair<K, V>>
		where N : RedBlackTreeNodeBase<K, V, N>
	{
		...
		public RedBlackTreePairEnumerator(IRedBlackTreeBase<K, V, N> redBlackTree)
		{
		...
		public KeyValuePair<K, V> Current
		{
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			get =>
				!_isFirst ? _currentNode.ToKeyValuePair()
					: throw new InvalidOperationException("RedBlackTreePairEnumerator has not started yet.");
		}
